...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setVec3("light.position", glm::vec3(sin(glfwGetTime()) * 5, 3.0f, cos(glfwGetTime()) * 5));
        ...
        model = glm::mat4(1.0f);
        model = glm::translate(model, glm::vec3(sin(glfwGetTime()) * 5, 3.0f, cos(glfwGetTime()) * 5));
